...
{
    public class MySqlExpressionParser : LinqExpressionParser
    {
        public string SqlWithParameters
        {
            get
            {
                ...
                {
                    tmp = tmp.Replace(p.Name, MySqlTools.FormatValueToString(p.Value));
                }
                return tmp;
            }
        }

        private MySqlExpressionParser()
        {
    ...
    public static class ExpressionExtentions
    {
        ...
        {
            MySqlExpressionParser sb = MySqlExpressionParser.Build(predicate, td);
            parameters = sb.Parameters;
            return sb.Sql;
        }
